...
class MainClass
{
    ...
    static void Main()
    {
        ...
        Expression<Func<int, bool>> test2 =
            ...
            iParam = Expression.Parameter(typeof(int), "i"),
            Expression.Constant(5, typeof(int))), iParam);

        Func<int, bool> meDele = test.Compile();
        Console.WriteLine(meDele(3));   //False
        Console.WriteLine(meDele(8));   //True
